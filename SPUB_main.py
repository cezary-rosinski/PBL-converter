...
tree = ET.ElementTree(places_xml)
ET.indent(tree, space="\t", level=0)
tree.write(f'./xml_output/import_retro_places_{filename}.xml', encoding='UTF-8')
...
tree = ET.ElementTree(persons_xml)
ET.indent(tree, space="\t", level=0)
tree.write(f'./xml_output/import_retro_people_{filename}.xml', encoding='UTF-8')
...
tree = ET.ElementTree(journals_xml)
ET.indent(tree, space="\t", level=0)
tree.write(f'./xml_output/import_retro_journals_{filename}.xml', encoding='UTF-8')
